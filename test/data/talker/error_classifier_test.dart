  ...
  group('FrameworkErrorClassifier', () {
    ...
    test('uses stable names for common non-failure errors', () {
      final dioError = DioException(
        ...
        response: Response<void>(requestOptions: RequestOptions(path: '/v1/alerts'), statusCode: 503),
      );

      expect(classifier.describe(dioError), 'DioException(503)');
      expect(classifier.describe(PlatformException(code: 'camera_denied')), 'PlatformException(camera_denied)');
...
final class _SignatureFailure extends DomainError {
  ...
  const _SignatureFailure({super.message, super.cause});
}
